				  ...
				  <div class="banner">
  					...
  					<div class="carousel-inner">
  						<div class="carousel-item active">
  							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/dist/images/Screenshot_2.jpg" class="d-block w-50" alt="...">
  						</div>
  						<div class="carousel-item">
  							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/dist/images/Screenshot_3.jpg" class="d-block w-50" alt="...">
  						</div>
  						<div class="carousel-item">
  							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/dist/images/Screenshot_4.jpg" class="d-block w-50" alt="...">
  						</div>
  					</div>
